...
public class Task_10_IE {
    ...
    public void execute() {
        ...
        Assert.assertEquals(driver.findElement(By.cssSelector("#box-campaigns > div > ul > li > a.link > div.price-wrapper > s")).getCssValue("text-decoration"), "line-through");
        ...
        Assert.assertEquals(driver.findElement(By.cssSelector("#box-product > div.content > div.information > div.price-wrapper > s")).getCssValue("text-decoration"), "line-through");
