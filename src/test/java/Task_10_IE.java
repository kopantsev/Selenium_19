...
public class Task_10_IE {
    ...
    public void execute() {
        ...
        Assert.assertEquals(driver.findElement(By.cssSelector("#box-campaigns s")).getCssValue("text-decoration"), "line-through");
        ...
        Assert.assertEquals(driver.findElement(By.cssSelector("s.regular-price")).getCssValue("text-decoration"), "line-through");
